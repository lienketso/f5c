...
Class User extends MY_Controller{
	...
	function register(){
				if($this->input->post()){
				$this->form_validation->set_rules('email','Địa chỉ email','required|valid_email|is_unique[user.email]');
	...
	function index(){
		...
		$orderUser = $this->transaction_model->get_list($input);
		$this->data['orderUser'] = $orderUser;

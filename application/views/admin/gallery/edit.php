...
<li class="breadcrumb-item"><a href="<?= admin_url('gallery?group='.$info->group_id); ?>">Thư viện</a></li>
<li class="breadcrumb-item active" aria-current="page">Sửa hình ảnh </li>
</ol>
</nav>
...
<div class="card">
<div class="card-body">
<h4 class="card-title">Nhập thông tin để sửa hình ảnh</h4>
<div class="form-group" style="text-align: right;">
<a href="<?= admin_url('gallery?group='.$info->group_id) ?>" class="btn btn-light"><i class="ti-arrow-left"></i> Quay lại danh sách</a>
...
<textarea name="description" class="form-control" placeholder="Mô tả ngắn gọn" rows="4"><?= $info->description; ?></textarea>
</div>
<div class="form-group">
<label for="exampleInputUsername1">Link</label>
<input type="text" name="link" value="<?= $info->link; ?>" class="form-control" placeholder="Nhập link liên kết">
<span id="" class="error mt-2 text-danger" for=""><?php echo form_error('link'); ?></span>
</div>
<div class="form-group">
<label for="exampleInputUsername1">Thứ tự</label>
<input type="text" name="is_order" value="<?= $info->is_order; ?>" class="form-control" placeholder="Thứ tự hiển thị">

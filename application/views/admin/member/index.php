...
<form method="GET" action="<?php echo admin_url('member'); ?>">
<div class="span12">
...
<form name="theForm" id="theForm" action="<?= admin_url('member/delete_all') ?>" method="post">
<input type="hidden" name="btnOnclick" value="">
<div class="" style="text-align: right;padding-bottom: 10px">
<a href="<?php echo admin_url('member/add'); ?>" class="btn btn-small btn-success"><i class="ti-write"></i> Thêm mới</a>

...
<li class="breadcrumb-item active" aria-current="page">Danh sách sản xuất</li>
</ol>
</nav>
...
<form method="GET" action="<?php echo admin_url('service'); ?>">
<div class="span12">
...
<a href="<?= admin_url('news?type=service'); ?>" class="btn btn-secondary">Làm lại</a>
</div>
</div>
</form>
</div>

...
<form class="forms-sample" method="post" action="" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Nhập thông tin để sửa đề án</h4>
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<div id="datepicker-popup" class="input-group date datepicker-popup">
							<input type="text" name="created_at" value="<?=showdate_vn($info->created_at); ?>" class="form-control">
					...
					<div class="form-group">
						...
						<select name="display" class="form-control form-control-sm" id="exampleFormControlSelect4">
							...
							<option value="1" <?= ($info->display==1) ? 'selected' : '' ?>>Trang chủ</option>
							<option value="2" <?= ($info->display==2) ? 'selected' : '' ?>>Chân trang</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group col-xs-12">
							<input type="text" value="<?= $info->image_single ?>" name="image_single" id="bnProduct" class="form-control file-upload-info" placeholder="Upload Image">
							<span class="input-group-append">

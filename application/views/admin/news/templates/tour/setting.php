<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Cấu hình trang du lịch</li>
  </ol>
</nav>
...
<form class="forms-sample" method="post" action="" enctype="multipart/form-data">
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Nhập thông tin cấu hình trang du lịch</h4>
                ...
                <div class="tab-pane fade show active" id="home-2" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      <input type="text" value="<?= $arrSetting['tour_home_image']; ?>" name="tour_home_image" id="bnProduct" class="form-control file-upload-info" placeholder="Upload Image">
                  ...
                  <div class="form-group" id="">
                    ...
                    <input type="text" name="tour_home_title_<?= $lang ?>" value="<?= $arrSetting['tour_home_title_'.$lang] ?>" class="form-control" placeholder="Du lịch">
                  </div>
                  <div class="form-group">
                    <label for="">Mô tả</label>  
                    <div id="">
                      <textarea name="tour_home_desc_<?= $lang ?>" class="makeMeRichTextarea" id="edtone"><?= $arrSetting['tour_home_desc_'.$lang]; ?></textarea>
                    </div>
                  </div>
                </div>

<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?= admin_url('news?type='.$type); ?>">Đề án</a></li>
		<li class="breadcrumb-item active" aria-current="page">Thêm mới đề án</li>
	</ol>
</nav>
<form class="forms-sample" method="post" action="" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Nhập thông tin để thêm đề án</h4>
					...
					<div class="form-group">
						<label for="exampleInputUsername1">Chi tiết đề án</label>	
						<div id="">
		...
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						<label for="exampleFormControlSelect3">Danh mục đề án</label>
						<?php $this->catnews_model->checkboxCatnews(0,1,4,0,$type); ?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select name="display" class="form-control form-control-sm" id="exampleFormControlSelect4">
							...
							<option value="2">Chân trang</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group col-xs-12">
							<input type="text" name="image" value="<?= set_value('image') ?>" id="xFilePath" class="form-control file-upload-info" placeholder="Upload Image">
					...
					<div class="form-group">
						...
						<div class="input-group col-xs-12">
							<input type="text" value="<?= set_value('image_single'); ?>" name="image_single" id="bnProduct" class="form-control file-upload-info" placeholder="Upload Image">
							<span class="input-group-append">

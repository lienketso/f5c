...
<input type="text" name="email" value="<?= $info->email; ?>" class="form-control" placeholder="Nhập tên tài khoản">
<span id="" class="error mt-2 text-danger" for=""><?php echo form_error('email'); ?></span>
</div>
<div class="form-group">
<label for="">Mật khẩu</label>
<input type="password" name="password" value="<?= set_value('password'); ?>" class="form-control" placeholder="Để trống nếu không đổi mật khẩu">
<span id="" class="error mt-2 text-danger" for=""><?php echo form_error('password'); ?></span>
</div>
<div class="form-group">
<label for="">Nhập lại mật khẩu</label>
<input type="password" name="repassword" value="<?= set_value('repassword'); ?>" class="form-control" placeholder="Để trống nếu không đổi mật khẩu">
...
<input type="text" name="address" value="<?= $info->address; ?>" class="form-control" placeholder="Nhập địa chỉ">
...
<select name="sex" class="form-control">
	<option value="0" <?= ($info->sex==0) ? 'selected' : '' ?>>Nam</option>
	<option value="1" <?= ($info->sex==1) ? 'selected' : '' ?>>Nữ</option>
</select>
</div>

<div class="form-group">
<label for="">Ngày sinh</label>
<input type="text" name="birthday" value="<?= $info->birthday; ?>" class="form-control" placeholder="15/07/1989">

						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<?php foreach($cvalues as $row): ?>
									<option value="<?= $row->id; ?>" <?= (set_value('cvalue_id') == $row->id ? "selected" : "") ?> ><?= $row->name; ?></option>
								<?php endforeach; ?>
								</select>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="type">
									...
									<option value="radio" <?= (set_value('type') == 'radio' ? "selected" : "") ?> >Radio</option>
									<option value="checkbox" <?= (set_value('type') == 'checkbox' ? "selected" : "") ?> >Checkbox</option>
								</select>
								<div class="help-block"><?php echo form_error('name'); ?></div>
							</div>
						</div>

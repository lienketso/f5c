				...
				<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								...
								<?php foreach($category as $row): ?>
									<option value="<?= $row->id; ?>" <?= ($row->id==$info->category_id ? 'selected' : '' ) ?> ><?= $row->name; ?></option>
								<?php endforeach; ?>
								</select>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span6 typeahead" name="name" id="" value="<?= $info->name; ?>" >
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span6 typeahead" name="is_order" value="<?= $info->is_order; ?>" >
							</div>
						</div>  

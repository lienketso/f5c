	...
	<div id="content" class="card">
		<div class="card-body">
			<div class="thanhtimkiem">
				<form method="GET" action="<?php echo admin_url('district'); ?>">
					<div class="span12">
									...
									<tbody class="list_item">
										<?php foreach($list as $row) : ?>
											...
											<tr class="row_<?php echo $row->id; ?>">
												...
												<td><a class="addnew" href="<?= admin_url('thixa/add?district_id='.$row->id) ?>" title="Thêm Xã Phường cho Huyện này"> + Thêm Xã Phường</a></td>
												...
												<td class="center">
													<a class="btn btn-sm btn-info" href="<?php echo admin_url('district/edit/'.$row->id); ?>">
														<i class="ti-pencil-alt"></i>  
													</a>
													<a class="btn btn-sm btn-danger" href="<?php echo admin_url('district/del/'.$row->id); ?>" onclick="return check_del();">
														<i class="ti-trash"></i>  
													</a>
												</td>
											</tr>

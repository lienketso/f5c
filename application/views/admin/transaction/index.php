...
<a href="<?= admin_url('transaction'); ?>" class="btn btn-secondary">Làm lại</a>
</div>
</div>
</form>
</div>
...
<form name="theForm" id="theForm" action="<?= admin_url('transaction/delete_all') ?>" method="post">
...
<td>
	<?php 
		$customer = unserialize($row->contact);
	?>
	<ul class=list-cus>
...
<td>
	<?php if($row->payment=='home'): ?>
	<span>Tại nhà</span>
	<?php endif; ?>
	<?php if($row->payment=='bank_tranfer'): ?>
	<span>Chuyển khoản</span>
	<?php endif; ?>
	<?php if($row->payment=='baokim'): ?>
	<span>Cổng Bảo Kim</span>
	<?php endif; ?>
	<?php if($row->payment==''): ?>
	<span>Mặc định</span>
	<?php endif; ?>
...
<td class="center">
<a class="btn btn-sm btn-info" href="<?php echo admin_url('transaction/view/'.$row->id); ?>">
<i class="ti-pencil-alt"></i>  
</a>
<a class="btn btn-sm btn-danger" href="<?php echo admin_url('transaction/del/'.$row->id); ?>" onclick="return check_del();">
<i class="ti-trash"></i>  
</a>
</td>
</tr>

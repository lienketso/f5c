                    ...
                    <form class="form-cart" method="post" action="">
                                ...
                                <li class="media">
                                    <div class="media-left">
                                        <a href="<?= product_url(slug($product->name),$product->id) ?>" target="_blank">
                                            <img data-src="<?= url_tam($product->image_name) ?>"
                                                src="<?= url_tam($product->image_name) ?>" alt="<?= $product->name; ?>"
                                    ...
                                    <div class="media-body">
                                        <div class="product-name">
                                            <h4><a href="<?= product_url(slug($product->name),$product->id) ?>"
                                        ...
                                        <div class="input-group ">
                                            <div class="btn-group" role="group" aria-label="...">
                                                <button type="button" data-type="minus"
                                                    data-field="qty_<?= $row['id']; ?>"
                                                    data-rowid="<?= $row['rowid'] ?>"
                                                    data-link="<?= base_url('cart/updateOnecart') ?>"
                                                    class="btn btn-default btn-number"><i class="fa fa-minus"
                                                        aria-hidden="true"></i></button>
                                                <input type="text" class="input-number" name="qty_<?= $row['id']; ?>"
                                                    value="<?= $row['qty']; ?>" />
                                                <button type="button" id="tanglen" data-type="plus"
                                                    data-field="qty_<?= $row['id']; ?>"
                                                    data-rowid="<?= $row['rowid'] ?>"
                                                    data-link="<?= base_url('cart/updateOnecart') ?>"
                        ...
                        <section class='total-bill'>
                            <div class="form-group">
                                <div class="total-provisional"><span class="total-product-quantity">Tạm tính
                                        (<?= $total_items ?> sản
                                        phẩm):</span>
                        ...
                        <section class="info-customer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <input type="text" name="fullname"
                                            value="<?= (!empty($userLogin)) ? $userLogin->name : set_value('fullname') ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="phone"
                                            value="<?= (!empty($userLogin)) ? $userLogin->phone : set_value('phone') ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="slEmail"
                                            value="<?= (!empty($userLogin)) ? $userLogin->email : set_value('slEmail') ?>"
                        ...
                        <section class="info-order">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home" onclick="checkOpt('1')">
                                        <input type="radio" name="optorder" value="Giao tận nơi"> &nbsp;Giao tận nơi</a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="home" class="tab-pane fade in active">
                                    <div class="col-md-12">
                                        <div class="text-tb">Chọn địa chỉ để biết thời gian nhận hàng và phí vận chuyển
                                            (nếu có)</div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select id="changeCity" data-link="<?= base_url('cart/getDistrict') ?>"
                                                class="select2 form-control" name="slThanhPho">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" name="slAddress"
                                                value="<?= (!empty($userLogin)) ? $userLogin->address : set_value('slAddress') ?>"
                                                class="form-control" placeholder="Địa chỉ chi tiết *">
                                ...
                                <div id="shop" class="tab-pane fade">
                                    <div class="col-md-12">
                                        <div class="text-tb"> <?= $this->site_model->getSettingMeta('site_company'); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <input type="text" name="yeucau" value="<?= set_value('yeucau') ?>" class="form-control"
        ...
        <input type="text" name="masothue" class="form-control" placeholder="Mã số thuế">
                        ...
                        <section class="info-payment">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="radio-inline"><input type="radio" value="bank_tranfer"
                                                name="optPayment" id="ckChuyenKhoan">Chuyển
                                            khoản</label>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <!-- <?= $this->site_model->getSettingMeta('site-notice_content'); ?> -->
                                            <h5><b>Miền Bắc & Miền Trung: Ông NGUYỄN HOÀNG HẠNH</b></h5>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 01:</h4>
                                                    Số tài khoản: <b>8285.8888</b>
                                                    <br />Ngân hàng: <b>Ngân hàng ACB </b>
                                                    <br />Chi nhánh: <b>Phòng giao dịch Đông Đô</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 02:</h4>
                                                    Số tài khoản: <b>0011003628864</b>
                                                    <br />Ngân hàng: <b> Ngân hàng TMCP Ngoại Thương VN
                                                        (Vietcombank)</b>
                                                    <br />Chi nhánh: <b>Sở giao dịch Hà Nội</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 03:</h4>
                                                    Số tài khoản: <b>19032433772989</b>
                                                    <br />Ngân hàng: <b> Ngân hàng TMCP Kỹ Thương VN (Techcombank)</b>
                                                    <br />Chi nhánh: <b>Sở giao dịch Hà Nội</b>
                                                </div>
                                            </div>
                                            <div class="clearfix" style="border: 1px solid #f8941d;margin: 20px 0 20px 0;"></div>
                                            <h5><b>Miền Nam: Bà NGUYỄN HOÀNG ĐIỆP</b></h5>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 01:</h4>
                                                    Số tài khoản: <b>044 100 401 9790</b>
                                                    <br />Ngân hàng: <b>Ngân hàng Vietcombank </b>
                                                    <br />Chi nhánh: <b>Tân Bình</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 02:</h4>
                                                    Số tài khoản: <b>121967519</b>
                                                    <br />Ngân hàng: <b> Ngân hàng ACB</b>
                                                    <br />Chi nhánh: <b>Phòng GD Võ Thành Trang</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 03:</h4>
                                                    Số tài khoản: <b>1606205567562</b>
                                                    <br />Ngân hàng: <b> Ngân hàng NN&PTNT</b>
                                                    <br />Chi nhánh: <b>An Phú</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 04:</h4>
                                                    Số tài khoản: <b>060067811881</b>
                                                    <br />Ngân hàng: <b> Ngân hàng Sacombank</b>
                                                    <br />Chi nhánh: <b>Phòng giao dịch Cộng Hoà - Chi nhánh Tân
                                                        Bình</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 05:</h4>
                                                    Số tài khoản: <b>14410000088299</b>
                                                    <br />Ngân hàng: <b> Ngân hàng BIDV </b>
                                                    <br />Chi nhánh: <b>Thống Nhất -TP.HCM</b>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading"><i class="fa fa-hand-o-right"
                                                            aria-hidden="true"></i>Tài khoản 06:</h4>
                                                    Số tài khoản: <b>19032505286014</b>
                                                    <br />Ngân hàng: <b> Ngân hàng Techcombank </b>
                                                    <br />Chi nhánh: <b>Chi nhánh Cộng Hòa - TP.HCM</b>
                                                </div>
                                            </div>
                                            <h4 style="color: #f8941d;">Khi kiểm tra được số tiền quý khách từ ngân hàng, chúng tôi sẽ thực hiện đơn hàng theo yêu cầu.</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>

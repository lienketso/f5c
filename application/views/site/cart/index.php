...
<div class="row">
    ...
    <div class="col-md-6 ">
        <div class="form-group">
            <input type="text" name="fullname" value="<?= (!empty($userLogin)) ? $userLogin->name : set_value('fullname') ?>" class="form-control" placeholder="Họ và tên *">
            <div class="alert-err"><?= form_error('fullname') ?></div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <input type="text" name="phone" value="<?= (!empty($userLogin)) ? $userLogin->phone : set_value('phone') ?>" class="form-control" placeholder="Số điện thoại *">
             <div class="alert-err"><?= form_error('phone') ?></div>
        </div>
    </div>
    <div class="col-md-12">
            <div class="form-group">
                <input type="text" name="slEmail" value="<?= (!empty($userLogin)) ? $userLogin->email : set_value('slEmail') ?>" class="form-control" placeholder="Email">
...
<div class="tab-content">
    ...
    <div id="home" class="tab-pane fade in active">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <input type="text" name="slAddress" value="<?= (!empty($userLogin)) ? $userLogin->address : set_value('slAddress') ?>" class="form-control" placeholder="Địa chỉ chi tiết *">

...
class Google_maps {
	...
	var $apiKey						= 'AIzaSyDEmepooVgrFiAho5-9GckPB6Hmqmx0sRg'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
